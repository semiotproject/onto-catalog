...
public interface ServiceConfig extends Config{
    ...
    @DefaultValue("http://localhost:8080/fuseki/private/data")
    @Key("fuseki.dataset.url")
    String datasetUrl();
    
    @DefaultValue("http://localhost:8080/fuseki/private/update")
    ...
    @DefaultValue("http://semdesc.semiot.ru/api/login/code/")
    @Key("github.callback")
    String githubUrl();
}
